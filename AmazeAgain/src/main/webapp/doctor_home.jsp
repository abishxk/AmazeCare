    ...
    <div class="col-md-6">
      <div class="card text-white bg-primary h-100">
        <div class="card-body text-center">
          ...
          <a href="doctor_view_appointments.jsp" class="btn btn-light">View</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card text-white bg-success h-100">
        <div class="card-body text-center">
          ...
          <a href="conduct_consultation.jsp" class="btn btn-light">Start</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card text-white bg-info h-100">
        <div class="card-body text-center">
          ...
          <a href="update_medical_records.jsp" class="btn btn-light">Update</a>
        </div>
      </div>
    </div>
