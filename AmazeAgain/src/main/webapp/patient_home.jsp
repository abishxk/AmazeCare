        ...
        <div class="col-md-6">
            <div class="card text-white bg-success h-100">
                <div class="card-body text-center">
                    ...
                    <a href="schedule_appointment.jsp" class="btn btn-light">Schedule</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card text-white bg-info h-100">
                <div class="card-body text-center">
                    ...
                    <a href="view_appointments.jsp" class="btn btn-light">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card text-white bg-secondary h-100">
                <div class="card-body text-center">
                    ...
                    <a href="medical_history.jsp" class="btn btn-light">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card text-white bg-danger h-100">
                <div class="card-body text-center">
                    ...
                    <a href="cancel_appointment.jsp" class="btn btn-light">Cancel</a>
                </div>
            </div>
        </div>
